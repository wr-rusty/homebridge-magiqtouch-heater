...
export const WEBSOCKET_URL = 'https://xs5z2412cf.execute-api.ap-southeast-2.amazonaws.com/prod?token=';
...
export class MagIQTouchWebSocket extends EventEmitter {
    ...
    pingIntervalMs;
    livenessTimeoutMs;
    constructor(getToken, macAddress, log, opts = {}) {
        super();
    ...
    requestStatus(timeout = DEFAULT_TIMEOUT_MS) {
     ...
     */
    sendCommand(params, checker, timeout = DEFAULT_TIMEOUT_MS) {
